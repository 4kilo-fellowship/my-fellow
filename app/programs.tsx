    ...
    >
      ...
      <View className="h-52 w-full relative">
        ...
        <View className="absolute bottom-4 left-5 right-5">
          <Text className="text-white text-2xl font-extrabold" style={{ textShadowColor: 'rgba(0,0,0,0.5)', textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 4 }}>
            {item.title}
          </Text>
        </View>
      </View>
      ...
      <View className="p-5">
        ...
        <TouchableOpacity
          activeOpacity={0.7}
          onPress={() => openGoogleMaps(item.coordinates.lat, item.coordinates.lng, item.location)}
        ...
        >
          <View className="flex-row items-center flex-1">
            ...
            <View className="flex-1">
              <Text className={`text-xs font-medium mb-0.5 ${isDark ? "text-gray-500" : "text-gray-400"}`}>
                Location
              </Text>
              <Text
